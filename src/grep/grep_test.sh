...
echo -----------------------------------------------------TEST_S_FLAG_3
grep -s A ../common/test_3.txt > grep_test_3_s
./s21_grep -s A ../common/test_3.txt > s21_grep_test_3_s
if (diff -s grep_test_3_s s21_grep_test_3_s); then
    echo "PASSED ✅"
else
    echo "FAIL ❌"
fi
rm -f grep_test_3_s s21_grep_test_3_s
echo -----------------------------------------------------TEST_F_FLAG_1
grep -f twenty ../common/test_4.txt > grep_test_1_f
./s21_grep -f twenty ../common/test_4.txt > s21_grep_test_1_f
if (diff -s grep_test_1_f s21_grep_test_1_f); then
    echo "PASSED ✅"
else
    echo "FAIL ❌"
fi
rm -f grep_test_1_f s21_grep_test_1_f
echo -----------------------------------------------------TEST_F_FLAG_2
grep -f Hello ../common/test_2.txt > grep_test_2_f
./s21_grep -f Hello ../common/test_2.txt > s21_grep_test_2_f
if (diff -s grep_test_2_f s21_grep_test_2_f); then
    echo "PASSED ✅"
else
    echo "FAIL ❌"
fi
rm -f grep_test_2_f s21_grep_test_2_f
echo -----------------------------------------------------TEST_F_FLAG_3
grep -f A ../common/test_3.txt > grep_test_3_f
./s21_grep -f A ../common/test_3.txt > s21_grep_test_3_f
if (diff -s grep_test_3_f s21_grep_test_3_f); then
    echo "PASSED ✅"
else
    echo "FAIL ❌"
fi
rm -f grep_test_3_f s21_grep_test_3_f
echo -----------------------------------------------------TEST_O_FLAG_1
